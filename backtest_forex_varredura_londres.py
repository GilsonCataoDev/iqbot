"""Valida varredura da faixa asiática na abertura de Londres como Forex."""
...
def relatorio(base: pd.DataFrame, estresse: pd.DataFrame) -> bool:
    print("\nVarredura Asia-Londres | M15 | SL/TP=2R | horario Europe/London")
    print("Faixa 00-08h; varredura e fechamento de volta entre 08-11h; uma entrada/par/dia.")
    if base.empty:
