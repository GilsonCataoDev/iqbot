"""Backtest da continuação após deslocamento M15 anormal."""
...
def executar(dados,fator=1):
    ...
    for a,c in dados.items():
        r,_=simular_forex(a,c,banca=10_000,risco_percentual=.0025,spread=SPREAD.get(a,SPREAD_PADRAO)*fator,estrategia="continuacao_choque_m15")
...
def main():
    ...
    print("\nContinuacao de choque M15 | EURUSD/USDJPY | TP=2R")
    ...
    imprimir("treino 70%",o[o.aberta_em<c]);mh=imprimir("holdout 30%",o[o.aberta_em>=c]);m15=imprimir("spread 1,5x",s15);m20=imprimir("spread 2,0x",s20)
