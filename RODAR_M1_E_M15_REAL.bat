...
start "IQ Bot M15 [REAL]" cmd /k "chcp 65001 >nul && cd /d "%~dp0" && if exist ".env.bat" call ".env.bat" && python rodar_iqoption_m5.py --scalping-m15 --confirmo"

:: Aguarda 5s para escalonar o login (evita race na conexao WebSocket)
